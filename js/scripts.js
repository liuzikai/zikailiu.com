(function (factory) {
  ...
  class Collapse extends BaseComponent {
    ...
    show() {
      ...
      const complete = () => {
        ...
        this._element.classList.add(CLASS_NAME_COLLAPSE, CLASS_NAME_SHOW$3);
  ...
  class Modal extends BaseComponent {
    ...
    dispose() {
      [window, this._dialog]
        .forEach(htmlElement => EventHandler.off(htmlElement, EVENT_KEY$2));
  ...
  const EVENT_SCROLL = `scroll${EVENT_KEY$1}`;
  ...
  class ScrollSpy extends BaseComponent {
    ...
    dispose() {
      EventHandler.off(this._scrollElement, EVENT_KEY$1);
      super.dispose();
    }
  ...
  */
  ...
  window.addEventListener("DOMContentLoaded", event => {
      ...
      var tooltipToggleElements = document.querySelectorAll('[data-toggle="tooltip"]');

      tooltipToggleElements.forEach(function(element) {
      ...
      if (currentPage === "home") {
          ...
          mm.add("(min-width: 992px)", () => {
              ...
              let projectsHoverAnimation = gsapWithCSS.timeline({paused: true})
              ...
              let photosHoverAnimation = gsapWithCSS.timeline({paused: true})
