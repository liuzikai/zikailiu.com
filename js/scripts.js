(function (factory) {
  ...
  } (baguettebox, baguettebox.exports));

  var baguetteboxExports = baguettebox.exports;
  var baguetteBox = /*@__PURE__*/getDefaultExportFromCjs(baguetteboxExports);
  ...
  window.addEventListener("DOMContentLoaded", event => {
      ...
      if (currentPage === "home") {
          ...
          mm.add("(min-width: 992px)", () => {
              ...
              gsapWithCSS.to("#biographyContainer", {
                  scrollTrigger: {
                      trigger: "#homeSection",
                      start: "top bottom",
                      end: "bottom bottom",
